...
class Profile < ApplicationRecord
  ...
  validates :major_category, numericality: { only_integer: true, greater_than_or_equal_to: 0, less_than_or_equal_to: 34, message: "%{attribute}は0〜34の数字を入力してください。" }, allow_nil: true
